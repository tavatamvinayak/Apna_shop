      ...
      <div className="grid md:grid-cols-4 md:gap-3 my-2">
        ...
        <div>
          <ul className="leading-9">
            ...
            <li><h1 className="font-bold inline-block">Size</h1> :{product.size.map((i)=><button className="p-1 border border-gray-400 mx-1">{i.size}</button>)} </li>
            <li><h1 className="font-bold inline-block">Category</h1>: {product.category}</li>
            <li><h1 className="font-bold inline-block">Brand</h1>: {product.brand}</li>
            ...
            <li> <h1 className="font-bold inline-block">Description</h1>: {product.description}</li>
            <br />
